		...
		<>
			...
			<Container maxW="4xl" my={12} sx={blurAppearance}>
				...
				<Box>
					...
					<Text>
						AIとデータの深い専門性を持ちながら、個人開発で幅広い経験を積んできたソフトウェアエンジニアです。アルゴリズムや基盤だけでなく、ユーザー体験の設計からフロントエンド、バックエンドまで自分でつなぎ、プロダクトとして素早く形にするのが得意です。
					</Text>
					<Text>
						東京大学大学院でケモインフォマティクスを専攻した後、DeNAで機械学習エンジニアとしてレコメンドや最適化に取り組みました。キャディでは機械学習基盤の構築やデータチームの立ち上げを担い、現在はAI
